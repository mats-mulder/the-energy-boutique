...
- template: content-right
  ...
  - title: Coaching
    content-block: "Goed in je vel zitten en meer energiek in het leven staan is nooit
      ...
      geest belangrijk. \n\nIn de gesprekken die je hebt met onze coach sta jij met
      jouw doel(en) centraal, zodat jij de veranderingen kan realiseren die voor jou
      belangrijk zijn. De coaching biedt inzichten en praktische tools om, in de dagelijkse
      drukte, andere keuzes te maken zodat jij jouw doelen kan behalen en kan behouden."
    extra_content_container:
      active: false
      title: ''
      image: ''
